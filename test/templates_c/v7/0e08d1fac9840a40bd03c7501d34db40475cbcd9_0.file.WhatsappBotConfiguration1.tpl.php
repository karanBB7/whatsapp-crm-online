<?php
/* Smarty version 3.1.39, created on 2023-10-06 09:43:06
  from 'C:\xampp\htdocs\vtigercrm\layouts\v7\modules\CTWhatsApp\WhatsappBotConfiguration1.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_651fd6aa7aee40_26166846',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0e08d1fac9840a40bd03c7501d34db40475cbcd9' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtigercrm\\layouts\\v7\\modules\\CTWhatsApp\\WhatsappBotConfiguration1.tpl',
      1 => 1696585094,
      2 => 'file',
    ),
  ),
...
function content_651fd6aa7aee40_26166846 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="flow-builder-dasboard-container  flow-builder-fixed-sidebar flow-builder-fixed-header">
        ...
        <?php echo '<script'; ?>
 src="layouts/v7/modules/CTWhatsApp/WhatsappBot/flowBuilder.min.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
...
">
            ...
            <div class="flow-builder-header__logo">
                <div>
                    <h4><a href="index.php?module=CTWhatsApp&view=WhatsappBot&mode=WhatsappBotList"><?php echo vtranslate('Flow Builder',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
</a></h4>
                </div>
            </div>
...
">
                                ...
                                <li class="">
                                    <a href="index.php?module=CTWhatsApp&view=WhatsappBot&mode=WhatsappBotConfiguration&duplicateRecordId=<?php echo $_smarty_tpl->tpl_vars['BOTRECORDID']->value;?>
">
                            ...
                            <div class="options-element-section">
                                <div class="form-group">
                                    ...
                                    <select class="select2 inputElement" id="messagetype">
                                        ...
                                        <option value="WhatsApp List message"><?php echo vtranslate('WhatsApp List message',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
</option>
 ...
 <i class="glyphicon glyphicon-question-sign" data-toggle="modal" data-target="#questionresModal"></i></li>
                            ...
                            <li>
                                <a href="javascript:void(0)" class="drag-drawflow" draggable="true" data-node="chatwithoperator-node" ondragstart="drag(event)"><i
                                        class="fa fa-fw fa-question-circle" style="color: #4ea9ff;"></i><label><?php echo vtranslate('Chat with Operator',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
</label></a>
                            </li>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document" style="margin-top:150px !important;">
            <div class="modal-content">
              ...
              <div class="modal-body"> 
                ...
                <a href="/layouts/v7/modules/CTWhatsApp/image/normalmessage.png" target="_blank" style="color: blue;"><?php echo vtranslate('click here',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
                ...
                <a href="/layouts/v7/modules/CTWhatsApp/image/buttonlistmessage.png" target="_blank" style="color: blue;"><?php echo vtranslate('click here',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
</a> <?php echo vtranslate('to preview',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
                ...
                <a href="/layouts/v7/modules/CTWhatsApp/image/buttonmessage.png" target="_blank" style="color: blue;"><?php echo vtranslate('click here',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
</a> <?php echo vtranslate('to preview',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
...
>
        ...
        <?php echo '<script'; ?>
 type="text/javascript" src="layouts/v7/modules/CTWhatsApp/WhatsappBot/flow-builder-custom.js"><?php echo '</script'; ?>
>
    </div>
</body>
