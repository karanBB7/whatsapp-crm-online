			        ...
			        <div class="row">
			        	<div class="dropdown">
				        	<div class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" style="float: right !important;margin: 0px 15px 0px 0px;">
								<a href="#"><p>{vtranslate('LBL_QUICKACTION', 'CTWhatsAppBusiness')} <img src="layouts/v7/modules/CTWhatsAppBusiness/image/listing_green.png" style="width: 20px;"></p></a>
							</div>

							<ul class="dropdown-menu whatsapMenus" role="menu" aria-labelledby="dropdownMenu1">
								<li class="">
									<a href="{$ANALYTICSURL}">
										<span id="refreshMessages" title="{vtranslate('LBL_TIMELINE', 'CTWhatsAppBusiness')}">
											<p><img src="layouts/v7/modules/CTWhatsAppBusiness/image/listing_green.png">
											{vtranslate('LBL_TIMELINE', 'CTWhatsAppBusiness')}</p>
										</span>
									</a>
								</li>
								<li class="">
									<a href="index.php?module=CTWhatsAppBusiness&view=List">
										<span id="refreshMessages" title="{vtranslate('LBL_WHATSAPPMESSAGE', 'CTWhatsAppBusiness')}">
											<p><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_messages.png">
											{vtranslate('LBL_WHATSAPPMESSAGE', 'CTWhatsAppBusiness')}</p>
										</span>
									</a>
								</li>
								<li class="">
								...
								<li class="">
									<a href="index.php?module=Workflows&parent=Settings&view=List">
										<span id="refreshMessages" title="{vtranslate('LBL_AUTOMATEWORKFLOW', 'CTWhatsAppBusiness')}">
											<p><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_workflow.png">
											{vtranslate('LBL_AUTOMATEWORKFLOW', 'CTWhatsAppBusiness')}</p>
										</span>
									</a>
								</li>
								<li class="hide">
									<a href="index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=WhatsappBotList">
										<span id="refreshMessages" title="{vtranslate('LBL_WHATSAPPBOT', 'CTWhatsAppBusiness')}">
											<p><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_chatboat.jpg">
											{vtranslate('LBL_WHATSAPPBOT', 'CTWhatsAppBusiness')}</p>
										</span>
									</a>
								</li>
								{if $ISADMIN eq 'on'}
									<li class="">
										<a href="index.php?module=CTWhatsAppBusiness&parent=Settings&view=WhatsAppUserList">
											<span id="refreshMessages" title="{vtranslate('LBL_SETUPWHATSAPP', 'CTWhatsAppBusiness')}">
												<p><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_setup.png">
												{vtranslate('LBL_SETUPWHATSAPP', 'CTWhatsAppBusiness')}</p>
											</span>
										</a>
									</li>
								{/if}
