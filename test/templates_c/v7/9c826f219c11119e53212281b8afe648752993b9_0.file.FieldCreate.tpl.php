...
function content_656dcc5c5d7028_99500228 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div></div><div class="form-group labelname"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_LABEL_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<span class="redColor" id="specialCharError">*</span></label><div class="controls col-sm-7"><input type="text" class='inputElement col-sm-9' maxlength="50" <?php if ($_smarty_tpl->tpl_vars['IS_FIELD_EDIT_MODE']->value) {?>disabled="disabled"<?php }?> name="fieldLabel" value="<?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
" data-rule-required='true' style='width: 75%' /></div></div><div class="form-group keylabel"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_KEY_LABEL_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-7"><input type="text" class='inputElement col-sm-9 keylabelinput' maxlength="50" <?php if ($_smarty_tpl->tpl_vars['IS_FIELD_EDIT_MODE']->value) {?>disabled="disabled"<?php }?> name="KeyLabel" value="<?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
" data-rule-required='true' style='width: 75%' placeholder="No Special characters allowed"/><br><br><span class="hide spanshow" style="color:red;font-size:10px;"><b>Note:- </b>No special characters or spaces allowed</span></div></div><div class="form-group relatedfield  hide"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_LABEL_RELATE_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-7"><select class="select2 col-sm-6" name="torelatefield"><?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div></div><div class="form-group relatedmodule  hide"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_LABEL_RELATE_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-7"><select class="select2 col-sm-6" name="torelatemodule"><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['SUPPORTED_MODULES']->value, 'MODULE_NAME', false, 'TRANSLATED_MODULE_NAME');
$_smarty_tpl->tpl_vars['MODULE_NAME']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['TRANSLATED_MODULE_NAME']->value => $_smarty_tpl->tpl_vars['MODULE_NAME']->value) {
$_smarty_tpl->tpl_vars['MODULE_NAME']->do_else = false;
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div></div><?php if (!$_smarty_tpl->tpl_vars['IS_FIELD_EDIT_MODE']->value) {?><div class="form-group supportedType lengthsupported"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_LENGTH',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
