...
{strip}
    <div class="row" style="margin-bottom: 70px;">
        <div class="col-lg-9">
            ...
            <div class="row form-group col-lg-12">
                <div class="col-lg-2" style="padding-left: 0px;">{vtranslate('MSGTEMPLATES', 'CTWhatsApp')}</div>
                <div class="col-lg-10">
            ...
            <div class="row form-group col-lg-12">
                ...
                <div class="col-lg-10">
                    <label>{vtranslate('LBL_NOTE', 'CTWhatsApp')}</label>
                    {vtranslate('LBL_ATTACHMENT_NOTES', 'CTWhatsApp')}
                </div>  
            </div>
            <div class="row form-group col-lg-12">
            ...
            <div class="msgwithouttext row form-group col-lg-12" style="margin-left: -14px;">    
                <div class="col-lg-2" style="margin: 0px 3px 0px -12px;">{vtranslate('LBL_MESSAGES', 'CTWhatsApp')}</div>
                <div class="col-lg-10">
            ...
            <div class="row form-group col-lg-12">
                <div class="col-lg-2 attachmentlabel hide" style="margin: 0px 3px 0px -12px;">{vtranslate('LBL_ATTACHMENT', 'CTWhatsApp')}</div>
            ...
            <div class="row form-group col-lg-12 templatesNotes hide">
                <div class="col-lg-2"></div>
                <div class="col-lg-10">
                    <label>{vtranslate('LBL_SENDNOWLATERNOTES', 'CTWhatsApp')}</label>                    
                </div>
            </div>
        </div>
    </div>
