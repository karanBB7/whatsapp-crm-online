<?php
/* Smarty version 3.1.39, created on 2023-10-06 09:38:41
  from 'C:\xampp\htdocs\vtigercrm\layouts\v7\modules\CTWhatsApp\DashBoard.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_651fd5a19f00f7_31944371',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fe3519e50c507b5d946951413c63900bb27b91a9' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtigercrm\\layouts\\v7\\modules\\CTWhatsApp\\DashBoard.tpl',
      1 => 1696585094,
      2 => 'file',
    ),
  ),
...
function content_651fd5a19f00f7_31944371 (Smarty_Internal_Template $_smarty_tpl) {
?><html>
	<head>
...
/css/DashBoard.css" rel="stylesheet">
		...
		<?php echo '<script'; ?>
 type="text/javascript" src="layouts/v7/modules/CTWhatsApp/WhatsappBot/jquery.dataTables.min.js"><?php echo '</script'; ?>
>
		<?php echo '<script'; ?>
 type="text/javascript" src="layouts/v7/modules/CTWhatsApp/WhatsappBot/dataTables.bootstrap.min.js"><?php echo '</script'; ?>
>
	</head>
	<body>
			        ...
			        <div class="row">
			        	<div class="dropdown">
				        	<div class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" style="float: right !important;margin: 0px 15px 0px 0px;">
								<a href="#"><p><?php echo vtranslate('LBL_QUICKACTION','CTWhatsApp');?>
 <img src="layouts/v7/modules/CTWhatsApp/image/listing_green.png" style="width: 20px;"></p></a>
							</div>
...
">
										<span id="refreshMessages" title="<?php echo vtranslate('LBL_TIMELINE','CTWhatsApp');?>
">
											<p><img src="layouts/v7/modules/CTWhatsApp/image/listing_green.png">
											<?php echo vtranslate('LBL_TIMELINE','CTWhatsApp');?>
</p>
										</span>
									</a>
								</li>
								<li class="">
									<a href="index.php?module=CTWhatsApp&view=List">
										<span id="refreshMessages" title="<?php echo vtranslate('LBL_WHATSAPPMESSAGE','CTWhatsApp');?>
">
											<p><img src="layouts/v7/modules/CTWhatsApp/image/wa_messages.png">
											<?php echo vtranslate('LBL_WHATSAPPMESSAGE','CTWhatsApp');?>
</p>
										</span>
									</a>
								</li>
...
">
								...
								<li class="">
									<a href="index.php?module=Workflows&parent=Settings&view=List">
										<span id="refreshMessages" title="<?php echo vtranslate('LBL_AUTOMATEWORKFLOW','CTWhatsApp');?>
">
											<p><img src="layouts/v7/modules/CTWhatsApp/image/wa_workflow.png">
											<?php echo vtranslate('LBL_AUTOMATEWORKFLOW','CTWhatsApp');?>
</p>
										</span>
									</a>
								</li>
								<li class="">
									<a href="index.php?module=CTWhatsApp&view=WhatsappBot&mode=WhatsappBotList">
										<span id="refreshMessages" title="<?php echo vtranslate('LBL_WHATSAPPBOT','CTWhatsApp');?>
">
											<p><img src="layouts/v7/modules/CTWhatsApp/image/wa_chatboat.jpg">
											<?php echo vtranslate('LBL_WHATSAPPBOT','CTWhatsApp');?>
</p>
										</span>
									</a>
								</li>
								<?php if ($_smarty_tpl->tpl_vars['ISADMIN']->value == 'on') {?>
									<li class="">
										<a href="index.php?module=CTWhatsApp&parent=Settings&view=WhatsAppUserList">
											<span id="refreshMessages" title="<?php echo vtranslate('LBL_SETUPWHATSAPP','CTWhatsApp');?>
">
												<p><img src="layouts/v7/modules/CTWhatsApp/image/wa_setup.png">
												<?php echo vtranslate('LBL_SETUPWHATSAPP','CTWhatsApp');?>
</p>
											</span>
										</a>
									</li>
