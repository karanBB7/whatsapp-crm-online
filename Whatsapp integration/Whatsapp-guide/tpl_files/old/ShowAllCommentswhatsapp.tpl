	...
	<form id="detailView" method="POST">
		...
		<div class="commentContainer commentsRelatedContainer container-fluid">
			...
			<div class="row bg-white">
				<div class="col-lg-6 sendmessage">
							...
							<div class="col-sm-2">
								<div class="col-sm-1 image ">
									<div class="media-left title">
											<div class="bgcol" style="width:100px; height:50px; font-size: 35px;">
												<div class="name text-center pt" style="color: #fff;font-size:15px;">User Replies<span><strong></strong></span></div>
											</div>
									</div>
								</div>
							</div>
