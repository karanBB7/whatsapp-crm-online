...
<script type="text/javascript" src="layouts/v7/modules/CTWhatsAppBusiness/WhatsappBot/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="layouts/v7/modules/CTWhatsAppBusiness/WhatsappBot/dataTables.bootstrap.min.js"></script>
                ...
                <div class="clearfix">
                    ...
                    <div class="btn-group pull-right" style="margin: 3px 10px 0px 0px;">
                      {if $ISADMIN eq 'on'}
                        ...
                        <button class="btn btn-success editButton hide" type="button" onclick="window.location.href='index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=whatsAppBotLicenseDetail'" style="margin: 0px 25px 0px 0px;">{vtranslate('LBL_LICENSE', $MODULENAME)}</button>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                      {/if}
                        ...
                        <a onclick="window.location.href='index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=whatsAppBotSetting'"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/settings_green.png" style="width: 24px;" title="{vtranslate('WHATSAPPBOT_BUTTON_SETTING', $MODULENAME)}"></a>
                        &nbsp;&nbsp;
                        <a onclick="window.location.href='index.php?module=CTWhatsAppBusiness&view=DashBoard&mode=moduleDashBoard&analytics=1'"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_analytics.png" style="width: 24px;" title="{vtranslate('LBL_ANALYTICS', $MODULENAME)}"></a>
                    </div>
                </div><hr>
