...
class Settings_CTWhatsAppBusiness_Uninstall_Action extends Vtiger_Save_Action {
    public function process(Vtiger_Request $request) {
        global $adb, $site_URL,$root_directory;
        $Vtiger_Utils_Log = true;
		include_once('vtlib/Vtiger/Module.php');

        $array = array('CTWhatsAppBusiness','CTWhatsAppTemplates');
        ...
        $result = Settings_CTWhatsAppBusiness_Record_Model::deleteModuleWhatsAppRelatedData();
