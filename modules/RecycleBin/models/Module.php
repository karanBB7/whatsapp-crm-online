...
class RecycleBin_Module_Model extends Vtiger_Module_Model {
	...
	public function getAllModuleList(){
		...
		$restrictedModules = array('Emails', 'ProjectMilestone', 'ModComments','ModCommentswhatsapp', 'Rss', 'Portal', 'Integration', 'PBXManager', 'Dashboard', 'Home', 'Events');
    ...
    public function deleteRelatedCommentswhatsapp($recordIds) {
		$db = PearDatabase::getInstance();
		$query = 'DELETE vtiger_crmentity.* FROM vtiger_crmentity '
				. 'INNER JOIN vtiger_modcommentswhatsapp ON vtiger_modcommentswhatsapp.modcommentsid = vtiger_crmentity.crmid '
				. 'WHERE vtiger_modcommentswhatsapp.related_to in(' . generateQuestionMarks($recordIds) . ')';
