 ...
 ************************************************************************************/
 ...
 class Settings_CTWhatsAppBusiness_WhatsAppUserList_View extends Settings_Vtiger_Index_View {
    ...
    public function process(Vtiger_Request $request) {
        ...
        $adminconfigData = Settings_CTWhatsAppBusiness_Record_Model::getUserConfigurationDataWithId();
        ...
        $licenseAction = CTWhatsAppBusiness_Record_Model::getWhatsappAccountDetail($license_key);
        ...
        $editURL = 'index.php?parent=Settings&module=CTWhatsAppBusiness&view=ConfigurationEdit&userid='.$configureUserid;
    ...
    function getHeaderScripts(Vtiger_Request $request) {
        ...
        $jsFileNames = array(
            "modules.Settings.$moduleName.resources.CTWhatsAppBusiness",
        );
