                ...
                <div class="row-fluid">
                    <div class="span12">
                        <span>
                            ...
                            <a class="cancelLink1" href="javascript:history.back()" type="reset" style="font-size: 14px;padding-left: 10px;color: red;">{vtranslate('LBL_CANCEL', $QUALIFIED_MODULE)}</a></center>
                        </span><br>
                    </div>
                </div>
            </form>
...
{literal}
<script type="text/javascript" src="layouts/v7/modules/CTWhatsAppBusiness/resources/jscolorpicker/jscolor.js"></script>
