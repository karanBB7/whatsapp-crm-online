      ...
      <!-- Modal content -->
        ...
        <p>
            ...
            <div class="flow-builder-header__logo">
                <div>
                    <h4><a href="index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=WhatsappBotList">{vtranslate('Flow Builder',$MODULENAME)}</a></h4>
                </div>
            </div>
                    ...
                    <div>
                        <div class="dropdown whatsapMainMenu">
                            ...
                            <ul class="dropdown-menu whatsapMenus" role="menu" aria-labelledby="dropdownMenu1" style="width:188px;">
                                ...
                                <li class="">
                                    <a href="index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=WhatsappBotConfiguration&duplicateRecordId={$BOTRECORDID}">
          ...
          <div class="modal-dialog modal-dialog-centered" role="document" style="margin-top:150px !important;">
            <div class="modal-content">
              ...
              <div class="modal-body"> 
                ...
                <a href="/layouts/v7/modules/CTWhatsAppBusiness/image/normalmessage.png" target="_blank" style="color: blue;">{vtranslate('click here',$MODULENAME)}</a> {vtranslate('to preview',$MODULENAME)}
                <br/>
                ...
                <a href="/layouts/v7/modules/CTWhatsAppBusiness/image/buttonlistmessage.png" target="_blank" style="color: blue;">{vtranslate('click here',$MODULENAME)}</a> {vtranslate('to preview',$MODULENAME)}
                <br/>
                ...
                <a href="/layouts/v7/modules/CTWhatsAppBusiness/image/buttonmessage.png" target="_blank" style="color: blue;">{vtranslate('click here',$MODULENAME)}</a> {vtranslate('to preview',$MODULENAME)}
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{vtranslate('Close',$MODULENAME)}</button>
              </div>
