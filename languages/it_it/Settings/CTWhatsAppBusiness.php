...
$languageStrings = Array(
	...
	'LBL_WHATSAPP_CONFIGURATION' => 'Configurazione di WhatsApp Business',
	'LBL_WHATSAPP_INFORMATION' => 'Informazioni di WhatsApp Business',
	'LBL_ACCESS_MODULE_TO_WhatsApp Business' => 'Scegli moduli/campi per ottenere laccesso a WhatsApp Business',
	'API_URL' => 'API URL',
	'API_KEY' => 'Chiave API',
	'AUTH_TOKEN' => 'Token di autenticazione',
	'LBL_SCANQR_CODE' => 'Connetti WhatsApp Business',
	'LBL_SELECTANOPTION' => 'Seleziona un opzione',
	'WhatsApp Configuration' => 'Configurazione di WhatsApp Business',
	'Next' => 'Il prossimo',
	'LBL_LOGOUT' => 'Disconnettersi',
	'LBL_DEACTIVATE'=>'Disattivare',
	'LBL_SELECT_AN_OPTION' => 'Seleziona un opzione',
	'LBL_REBOOT_WHATSAPP' => 'Riavvia WhatsApp Business',
	...
	'CUSTOMFIELD2' => 'Numero WhatsApp Business',
	'WHATSAPPNO' => 'My WhatsApp Business No',
	'MODULES' => 'Modulo',
	'WHATSAPP_NO_FIELD' => 'WhatsApp Business # campo',
	'ACTIVE' => 'Attivo',
	'ACTION' => 'Azione',
	'ALLOW_MODULE' => 'Consenti modulo selezionato',
	'WHATSAPP_PHONE_FIELD' => 'Campo telefono di WhatsApp Business',
	...
	'WHATSAPPCONNECTED' => 'Sei connesso con WhatsApp Business',
	'CODEINFORMATION' => 'Scansiona codice QR - Attendi 60 secondi per la connessione di WhatsApp Business',
...
Tempo di invio 500 messaggi = (500 messaggi / 15 Dimensioni batch) * 15 minuti = 500 minuti = 8 ore circa.',
	'WHATSAPP_POLICY' => 'Politica di WhatsApp Business',
	'POLICYINFORMATION' => 'Note importanti: <br> 1. Si consiglia di seguire',
	'POLICYINFORMATION1' => 'quando si invia un messaggio WhatsApp Business di massa da CRM. <br>
2. È consigliabile configurare le dimensioni minime di lotto e lintervallo di tempo massimo tra ciascun messaggio per inviare messaggi WhatsApp Business in sicurezza quando si utilizza la funzione Messaggio di massa. <br>
3. WhatsApp Business memorizza i numeri con il prefisso internazionale, quindi se il tuo numero non ha un prefisso internazionale, imposta "Prefisso internazionale" nella configurazione di WhatsApp Business per tutti i numeri di CRM di WhatsApp Business. <br>
Formato suggerito per memorizzare i record con il numero WhatsApp Business, formato di esempio: 1987654321 dove "1" è il prefisso internazionale e "987654321" è il tuo numero locale.',
	'WhatsApp Business Configuration' => 'Configurazione di WhatsApp Business',
	'LBL_UNKNOWNINFORMATION' => 'Se il messaggio WhatsApp Business è stato inviato dal cliente il cui numero non è in CRM come record e se si desidera consentire a tutti gli utenti non amministratori di vedere quel numero, è necessario abilitare questa funzione. Quindi tutti gli utenti non amministratori possono vedere quei messaggi facendo clic sullicona Global WhatsApp Business e vederli in "Messaggio da numeri sconosciuti"',
	...
	'RQRCODEINFORMATION1' => '1. Apri WhatsApp Business sul tuo telefono. <br>
2. Tocca Menu o Impostazioni e seleziona WhatsApp Business Web <br>
3. Puntare il telefono sul display del codice QR quando si fa clic sul pulsante "Scansione codice QR" <br> <br>',
	...
	'LBL_LICENSE_CONFIGURATION' => 'Configura licenza WhatsApp Business',
...
3. Attendere 1 minuto dopo la scansione del codice QR',
	'Save' => 'Salva',
	'Cancel' => 'Annulla',
	'WHATSAPPCONNECTED' => 'Sei connesso a <br> Numero WhatsApp Business:',
	...
	'LBL_UPDATETITLE' => 'fare clic per ottenere una versione aggiornata di "Integrazione WhatsApp Business" da CRMTiger.com',
    ...
    'WHATSAPPMANAGEMENT' => 'Gestione WhatsApp Business #',
    'SINGLE_WHATSAPP' => 'Numero unico WhatsApp Business per il CRM',
    'MULTIPLE_WHATSAPP' => 'Numero multiplo di WhatsApp Business per utenti o gruppi',
    'ALLOCATEMULTIPLEWHATSAPP' => 'Aggiungi utenti/gruppi per accedere o scansionare più WhatsApp Business',
    'LBL_EXPORTRECORD' => 'Esporta record',
	'LBL_EXPORTRECORDDES1' => 'Fai clic sul pulsante Scarica contatti per scaricare il file contacts.csv di tutti i tuoi contatti WhatsApp Business e importalo nel tuo rispettato modulo di vTiger CRM per inviare / ricevere messaggi WhatsApp Business.',
	'LBL_EXPORTRECORDDES2' => 'Riepilogo contatti WhatsApp Business',
	...
	'RQRCODEINFORMATION4' => 'Lintegrazione di WhatsApp Business funziona solo se il numero di cui esegui la scansione qui
dovrebbe essere disconnesso (Logout) dallinterfaccia Web.WhatsApp Business.',
    //Add new functionality

	'LBL_AUTORESPONDER' => 'Risposta automatica',
	'LBL_AUTORESPONDERTEXT' => 'Testo risposta automatica',
	'LBL_WHATSAPP_CONFIGURATION_USERS' => 'Utenti connessi a WhatsApp Business',
	'LBL_USERS' => 'Nome utente',
	'LBL_CONNECTED' => 'Collegata',
	'LBL_DISCONNECTED' => 'Non connesso',
	'LBL_SCAN_YOU_NUMBER' => 'Scansiona il tuo numero WhatsApp Business',

	'LBL_WHATSAPP_MODULE_NUMBERTO_ACCESS' => 'Modulo/numero WhatsApp Business Accesso utente',
	'LBL_GENERAL_SEETINGS' => 'Impostazioni generali',
	'LBL_AUTO_MESSAGE_RESPONDER' => 'Risponditore automatico dei messaggi',
	'LBL_COUNTRYCODE_DESCRIPTION' => "- WhatsApp Business ha richiesto che un numero sia un prefisso nazionale, quindi se il numero di telefono del cliente non ha il prefisso internazionale ed è contrassegnato come WhatsApp Business #, aggiungi il prefisso internazionale qui che lo aggiungerà come prefisso a tutto il tuo numero durante l'invio messaggio.<br>- NON UTILIZZARE questa funzione se disponi di un numero di telefono di più paesi poiché questa funzione si applica a tutti i numeri di telefono.",
	...
	'LBL_SELECT_MODULE_ERROR' => 'Seleziona almeno un modulo da utilizzare per WhatsApp Business',
	'LBL_SELECT_MULTIPLEUSER_ERROR' => 'Seleziona almeno un utente in Assegna più WhatsApp Business a.',
	'MULTIPLE_WHATSAPP_NOTES' => 'Nota:<br> 1. Affinché gli utenti possano vedere la scansione di WhatsApp Business da parte degli altri utenti, aggiungere tali utenti in un gruppo.<br>2. Qualsiasi utente del gruppo scansiona WhatsApp Business che accederà a WhatsApp Business ad altri utenti dello stesso gruppo.<br>3. Puoi aggiungere anche singoli utenti a WhatsApp Business.',

	'MULTIPLE_WHATSAPP_NOTES1' => 'Aggiungi/Rimuovi Utenti/Gruppi per usare WhatsApp Business # multipli',
	'MW_LABEL1' => 'Chi esegue la scansione di WhatsApp Business? (Utente)',
	'MW_LABEL2' => 'Chi usa WhatsApp Business? (Utenti/Gruppi)',
	'MW_ACTIVE' => 'Attivo',
	'MW_ACTION' => 'Azione',
	...
	'NAVIGATETIMELINE' => 'per inviare/ricevere messaggi WhatsApp Business ai tuoi contatti',
	'CLICK' => 'Clic',
	...
	'LBL_WHATSAPPNOTIFICATION' => 'Notifica push di WhatsApp Business',
	'LBL_NOTIFICATION_TONE' => 'Tono di notifica',
	'LBL_SILENT' => 'Silenzioso',
	'LBL_WHATSAPPLOG' => 'Registro WhatsApp Business',
	'LBL_WHATSAPPNOTIFICATION' => 'Notifica push WhatsApp Business',

	'LBL_WHASAPP_TON' => 'Predefinito WhatsApp Business',
	'LBL_WHASAPP_HANGOUT_MESSAGE' => 'Messaggio Hangout',
	'LBL_BOT_IDEALTIME' => 'Tempo ideale del robot',

	'Bot Ideal Time' => 'Bot Tempo ideale',
	'Minutes' => 'Minuti',
	'WhatsApp Bot' => 'Bot WhatsApp Business',

	'App Id' => "ID dell'app",
	'Whatsapp Business Account Id' => 'Whatsapp Business Account ID',
	'User Access Token' => 'Token di accesso utente',
	'WhatsApp No' => 'WhatsApp Business NO',
	'WHATSAPP_BUSINESS_ACCOUNT_SETUP' => "WhatsApp Business Configurazione dell'account",
	'WHATSAPP_USERS_ACCESS_CONFIGURATION' => "WhatsApp Business Configurazione di accesso dell'utente",
	'NEED_HELP' => 'Ho bisogno di aiuto? <a href="https://kb.crmtiger.com/knowledge-base/how-to-use-whatsapp-business-integration/" target="_blank"> clicca qui </a>',
);

$jsLanguageStrings = Array(
	'MSG_WHATSAPP_DEACTIVATE_POPUP'=>'Sei sicuro di voler disattivare la tua chiave di licenza?',
	'MSG_WHATSAPP_POPUP1'=>'Questo disinstallerà tutti i moduli di CTWhatsApp BusinessBusiness con i dati memorizzati relativi a CTWhatsApp BusinessBusiness e il tuo account con CRMTiger.com. <br/>
    ...
    'MSG_WHATSAPP_UNISTALL_SUCCESS'=>'CTWhatsApp BusinessBusiness disinstallato!',
    'WHATSAPP_UNISTALL_SUCCESS'=>'CTWhatsApp BusinessBusiness è stato disinstallato correttamente',
    ...
    'UPDATEMODULE' => 'Qualche problema nellaggiornamento del modulo WhatsApp Business',
    ...
    'MULTIPLETOSINGLE'=>'Cambiare da singolo a più utenti o più utenti a singolo cancellerà tutte le connessioni WhatsApp Business - Conferma',
    'JS_SELECT_MODULE' => 'Si prega di selezionare il modulo.',
    'CURENT_VERSION' => 'La tua versione di WhatsApp Business',
    'LATEST_VERSION' => 'Versione attuale di WhatsApp Business',
);
