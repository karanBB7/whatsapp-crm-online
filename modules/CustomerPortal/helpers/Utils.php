...
class CustomerPortal_Utils {
	...
	public static function isModuleActive($module) {
		...
		$defaultAllowedModules = array("ModComments","ModCommentswhatsapp",  "History", "Contacts", "Accounts");
	...
	static function resolveRecordValues(&$record, $user = null, $ignoreUnsetFields = false) {
		...
		if (is_array($activeFields) && $module !== 'ModComments' ||  $module !== 'ModCommentswhatsapp') {
