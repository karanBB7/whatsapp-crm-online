...
Vtiger.Class("CTWhatsAppBusiness_DashBoard_Js",{
            ...
            function(data) {
                ...
                if(data.result.length != 0){
                    for (var i = 0; i < data.result.length; i++) {
                        ...
                        var totalsendURL = 'index.php?module=CTWhatsAppBusiness&view=List&search_params=[[["message_type","e","Mass+Message"],["whatsapp_withoccode","c","'+data.result[i]['massMessageid']+'"]]]'+listviewHeader;

                        var totalReadURL = 'index.php?module=CTWhatsAppBusiness&view=List&search_params=[[["whatsapp_unreadread","e","Read"],["message_type","e","Mass+Message"],["whatsapp_withoccode","c","'+data.result[i]['massMessageid']+'"]]]'+listviewHeader;

                        var totalUnReadURL = 'index.php?module=CTWhatsAppBusiness&view=List&search_params=[[["whatsapp_unreadread","e","Unread"],["message_type","e","Mass+Message"],["whatsapp_withoccode","c","'+data.result[i]['massMessageid']+'"]]]'+listviewHeader;
                    ...
                    whatsappMassMessageHTML += '<h4>'+app.vtranslate('DATANOTFOUNT')+'</h4>';
                }
                                ...
                                point: {
                                    events: {
                                        click: function(e){
                                            ...
                                            var url = 'index.php?module=CTWhatsAppBusiness&view=List&search_params=[[["message_type","e","'+send+'"],["createdtime","bw","'+date+'"],["whatsapp_unreadread","e","'+readUnread+'"]]]';
...
jQuery(document).ready(function(){
    var thisInstance = new CTWhatsAppBusiness_DashBoard_Js();
