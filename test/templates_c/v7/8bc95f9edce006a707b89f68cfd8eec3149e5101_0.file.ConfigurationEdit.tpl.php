<?php
/* Smarty version 3.1.39, created on 2023-09-27 10:23:50
  from 'C:\xampp\htdocs\vtigercrm\layouts\v7\modules\Settings\CTWhatsApp\ConfigurationEdit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_651402b6be0d53_93258788',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8bc95f9edce006a707b89f68cfd8eec3149e5101' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtigercrm\\layouts\\v7\\modules\\Settings\\CTWhatsApp\\ConfigurationEdit.tpl',
      1 => 1695618298,
      2 => 'file',
    ),
  ),
...
function content_651402b6be0d53_93258788 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
</h3></div><div class="pull-right"><span><a href="https://kb.crmtiger.com/article-categories/whatsapp-integration-for-vtiger/" target="_blank" title="<?php echo vtranslate('LBL_HELP',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"><img src="layouts/v7/modules/Settings/CTWhatsApp/images/help.png" style="width: 26px;"></a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="hide" href="#" data-toggle="modal" data-target="#whatsapppolicy" style="color: blue;"><?php echo vtranslate('WHATSAPP_POLICY',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</a></center></button></div></div><hr><div style="float: left;width: 65%;"><div class="block"><form id="EditView" action="index.php" method="post" class="form-horizontal"><input type="hidden" name="module" value="CTWhatsApp" /><input type="hidden" name="parent" value="Settings" /><input type="hidden" name="action" value="SaveConfiguration" /><br><input type="hidden" name="whatsappstatus" value="<?php echo $_smarty_tpl->tpl_vars['WHATSAPPSTATUS']->value;?>
...
</h4></div></div><hr><?php }?><table class="table editview-table no-border"><tbody><tr class=""><td class="fieldLabel alignMiddle" style="width: 25%;"><label class=""><?php echo vtranslate('WHATSAPPMANAGEMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></td><?php if ($_smarty_tpl->tpl_vars['ADDMOREUSERS']->value == 1) {?><td><?php if ($_smarty_tpl->tpl_vars['WHATSAPPMANAGEMENT']->value == 'singleWhatsapp') {
echo vtranslate('SINGLE_WHATSAPP',$_smarty_tpl->tpl_vars['MODULE']->value);
} elseif ($_smarty_tpl->tpl_vars['WHATSAPPMANAGEMENT']->value == 'multipleWhatsapp') {
echo vtranslate('MULTIPLE_WHATSAPP',$_smarty_tpl->tpl_vars['MODULE']->value);
}?></td><?php } else { ?><td><input type="hidden" id="wpManagement" value="<?php echo $_smarty_tpl->tpl_vars['WHATSAPPMANAGEMENT']->value;?>
"><select name="whatsappmanagement" id="whatsappmanagement" style="width: 100%;" class="inputElement select2 hide"><option value="singleWhatsapp" <?php if ($_smarty_tpl->tpl_vars['WHATSAPPMULTIPLE']->value == 'singleWhatsapp') {?> selected <?php }
...
</option></select></td><?php }?></tr><tr class="multipleUserSelect hide"><input type="hidden" name="multi" id="multi" value="<?php echo $_smarty_tpl->tpl_vars['WHATSAPPMULTIPLE']->value;?>
"><td class="fieldLabel alignMiddle" style="width: 25%;"></td><td colspan="3"><b><?php echo vtranslate('MULTIPLE_WHATSAPP_NOTES1',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</b></td><td><b><?php echo vtranslate('MW_ACTION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</b></td></tr><?php if ($_smarty_tpl->tpl_vars['MAINSUBUSERS']->value) {
...
" style="overflow: hidden;display: -webkit-box;-webkit-line-clamp: 3;-webkit-box-orient: vertical;height: 60px;"><?php echo $_smarty_tpl->tpl_vars['MAINSUBUSERS_VALUE']->value['subUserName'];?>
 ...
 <?php }?></td><td><span class="editUsers" data-userid="<?php echo $_smarty_tpl->tpl_vars['MAINSUBUSERS_VALUE']->value['userid'];?>
"><i class="fa fa-pencil"></i></span>&nbsp;&nbsp;<span class="deleteUsers" data-userid="<?php echo $_smarty_tpl->tpl_vars['MAINSUBUSERS_VALUE']->value['userid'];?>
" style="cursor: pointer;"><i class="fa fa-trash"></i></span></td></tr><?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
} else { ?><tr class="multipleUserSelect"><td class="fieldLabel alignMiddle" style="width: 25%;"></td><td colspan="3"><br><b><?php echo vtranslate('LBL_ATLEAST_CREATE_RECORD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</b></td></tr><?php }?><tr class="singleUserSelect <?php if ($_smarty_tpl->tpl_vars['WHATSAPPMANAGEMENT']->value == 'multipleWhatsapp') {?> hide <?php }?>"><?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></tr></tbody></table><br><br><?php if ($_smarty_tpl->tpl_vars['ADDMOREUSERS']->value != 1) {?><br><br><div class="clearfix"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><h4 style="margin-top: 0px;"><?php echo vtranslate('LBL_GENERAL_SEETINGS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</td><td class="fieldValue"><input type="checkbox" class="inputElement" name="iconactive" id="iconactive" <?php if ($_smarty_tpl->tpl_vars['ICONACTIVE']->value == 1) {?> checked <?php }?>></td></tr><tr class=""><td class="fieldLabel alignMiddle" style="width: 25%;"><?php echo vtranslate('LBL_NOTIFICATION_TONE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</option><option <?php if ($_smarty_tpl->tpl_vars['NOTIFICATIONTON']->value == 'layouts/v7/modules/CTWhatsApp/Whatsapp Default.mp3') {?> selected <?php }?> value="layouts/v7/modules/CTWhatsApp/Whatsapp Default.mp3"><?php echo vtranslate('WhatsApp Default',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</option><option <?php if ($_smarty_tpl->tpl_vars['NOTIFICATIONTON']->value == 'layouts/v7/modules/CTWhatsApp/Hangout Message.mp3') {?> selected <?php }?> value="layouts/v7/modules/CTWhatsApp/Hangout Message.mp3"><?php echo vtranslate('Hangout Message',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</option><option<?php if ($_smarty_tpl->tpl_vars['NOTIFICATIONTON']->value == 'silent') {?> selected <?php }?> value="silent"><?php echo vtranslate('LBL_SILENT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</td><td class="fieldValue"><input type="checkbox" class="inputElement" name="whatsapplog" id="whatsapplog" <?php if ($_smarty_tpl->tpl_vars['WHATSAPPLOG']->value == 1) {?> checked <?php }?>></td></tr><tr class=""><td class="fieldLabel alignMiddle" style="width: 25%;"><?php echo vtranslate('LBL_WHATSAPPNOTIFICATION',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</td><td class="fieldValue"><input type="checkbox" class="inputElement" name="notification" id="notification" <?php if ($_smarty_tpl->tpl_vars['WHATSAPPNOTIFICATION']->value == 1) {?> checked <?php }?>></td></tr><tr class=""><td class="fieldLabel alignMiddle" style="width: 25%;"><?php echo vtranslate('Bot Ideal Time',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></td></tr><tr><td class="fieldLabel alignMiddle" style="width: 25%;"><?php echo vtranslate('LBL_ALLOW_MASS_MESSAGE_USERS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</td><td class="fieldValue"><?php $_smarty_tpl->_assignInScope('ALL_ACTIVEUSER_LIST', $_smarty_tpl->tpl_vars['USER_MODEL']->value->getAccessibleUsers());
$_smarty_tpl->_assignInScope('ACCESSIBLE_USER_LIST', $_smarty_tpl->tpl_vars['USER_MODEL']->value->getAccessibleUsersForModule($_smarty_tpl->tpl_vars['MODULE']->value));?><select class="inputElement select2 select2-offscreen" id="allow_mass_message_access" name="allow_mass_message_access[]" style="width: 50%;" multiple="true"><?php
...
" <?php if ($_smarty_tpl->tpl_vars['MASSMESSAGEACCESSUSERS']->value[$_smarty_tpl->tpl_vars['OWNER_ID']->value] == $_smarty_tpl->tpl_vars['OWNER_ID']->value) {?> selected <?php }?>><?php echo $_smarty_tpl->tpl_vars['OWNER_NAME']->value;?>
</option><?php
}
