   ...
   function save_module($module) {
	...
	function vtlib_handler($modulename, $event_type) {
		...
		if($event_type == 'module.postinstall') {
			...
			$modcommentsModuleInstance = Vtiger_Module::getInstance('ModCommentswhatsapp');
			if($modcommentsModuleInstance && file_exists('modules/ModCommentswhatsapp/ModCommentswhatsapp.php')) {
				include_once 'modules/ModCommentswhatsapp/ModCommentswhatsapp.php';
				if(class_exists('ModCommentswhatsapp')) ModCommentswhatsapp::addWidgetTo(array('ProjectTask'));
			}
