...
<head>
	...
	<link rel="stylesheet"  type="text/css" href="layouts/v7/modules/CTWhatsApp/css/AllWhatsAppMSGRTL.css">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="dropdown">
						...
						<div class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" style="float: left; !important;">
							<a href="#"><p><img src="layouts/v7/modules/CTWhatsApp/image/listing_green.png" style="width: 20px;">{vtranslate('LBL_QUICKACTION', $MODULENAME)}</p></a>
						</div>
						<ul class="dropdown-menu whatsapMenus" role="menu" aria-labelledby="dropdownMenu1" style="width:340px;">
							<li class="hide">
								<a href="#">
									<span id="refreshMessages" title="{vtranslate('LBL_REFRESH', $MODULENAME)}">
										<p>{vtranslate('LBL_REFRESH', $MODULENAME)} <img src="layouts/v7/modules/CTWhatsApp/image/refresh.png">
										</p>
									</span>
								</a>
							</li>
							<li id="sendNewNumberMessage" title="{vtranslate('LBL_SEND_SMS_WHATSAPP', $MODULENAME)}">
								<a href="#">
									<p>{vtranslate('LBL_SEND_SMS_WHATSAPP', $MODULENAME)} <img src="layouts/v7/modules/CTWhatsApp/image/new-chat.png"></p>
								</a>
							</li>
							<li>
								<a href="index.php?module=CTWhatsAppTemplates&view=List">
									<p>{vtranslate('CTWhatsAppTemplates', 'CTWhatsAppTemplates')} <img src="layouts/v7/modules/CTWhatsApp/image/wa_templates.png" title="{vtranslate('CTWhatsAppTemplates', 'CTWhatsAppTemplates')}"/>
									</p>
								</a>
							</li>
							<li>
								<a href="index.php?module=Workflows&parent=Settings&view=List">
									<p>{vtranslate('LBL_AUTOMATEWORKFLOW', $MODULENAME)} <img src="layouts/v7/modules/CTWhatsApp/image/wa_workflow.png" title="{vtranslate('LBL_AUTOMATEWORKFLOW', $MODULENAME)}"/>
									</p>
								</a>
							</li>
							<li>
								<a href="index.php?module=CTWhatsApp&view=List">
									<p>{vtranslate('LBL_WHATSAPPMESSAGE', $MODULENAME)} {vtranslate('LBL_LOG', $MODULENAME)} <img src="layouts/v7/modules/CTWhatsApp/image/wa_messages.png" title="{vtranslate('LBL_WHATSAPPMESSAGE', $MODULENAME)}"/>
									</p>
								</a>
							</li>
							<li>
								<a href="index.php?module=WhatsAppLog&view=List">
									<p>{vtranslate('LBL_WHATSAPPMESSAGELOG', $MODULENAME)}<img src="layouts/v7/modules/CTWhatsApp/image/wa_messages.png" title="{vtranslate('LBL_WHATSAPPMESSAGELOG', $MODULENAME)}"/>
									</p>
								</a>
							</li>
							<li class="loadAllHistoryButton" data-allHistory='yes'>
								<a href="#">
									<p>{vtranslate('LBL_ALLMESSAGESHISTORY', $MODULENAME)} <img class="historyIcon" style="height: 20px;" src="layouts/v7/modules/CTWhatsApp/image/history.png" title="{vtranslate('LBL_ALLMESSAGESHISTORY', $MODULENAME)}"/></p>
								</a>
							</li>

							<li id="autoResponder" title="{vtranslate('LBL_AUTORESPONDERTEXT', 'Settings:CTWhatsApp')}">
								<a href="#">
									<p>{vtranslate('LBL_AUTORESPONDERTEXT', 'Settings:CTWhatsApp')} <img src="layouts/v7/modules/CTWhatsApp/image/auto-responder.png"></p>
								</a>
							</li>
							<li>
								<a href="index.php?module=CTWhatsApp&view=DashBoard&mode=moduleDashBoard&analytics=1">
									<p>{vtranslate('LBL_ANALYTICS', $MODULENAME)} <img src="layouts/v7/modules/CTWhatsApp/image/wa_analytics.png" title="{vtranslate('LBL_ANALYTICS', $MODULENAME)}"/>
									</p>
								</a>
							</li>
							...
							{if $ISADMIN eq 'on'}
								<li>
									<a href="index.php?module=CTWhatsApp&parent=Settings&view=WhatsAppUserList">
										<p>{vtranslate('LBL_SETUPWHATSAPP', $MODULENAME)} <img src="layouts/v7/modules/CTWhatsApp/image/wa_setup.png" title="{vtranslate('LBL_SETUPWHATSAPP', $MODULENAME)}"/>
										</p>
									</a>
								</li>
							{/if}
							...
							{if $ISADMIN eq 'on'}
								{if $WHATSAPPSTATUS eq 0}
									<li class="hide">
										<a href="index.php?module=CTWhatsApp&parent=Settings&view=WhatsAppUserList">
											<p>{vtranslate('LBL_SETUPWHATSAPP', $MODULENAME)} <img src="layouts/v7/modules/CTWhatsApp/image/login.png" title="{vtranslate('LBL_SETUPWHATSAPP', $MODULENAME)}"/>
											</p>
										</a>
									</li>
								{else}
									{if $MAINUSERSTAUSROWS eq 1}
										<li>
											<a href="index.php?module=CTWhatsApp&view=DashBoard&mode=moduleDashBoard&whatsapp_action=logout&showqrcode=1">
												<p>{vtranslate('LBL_LOGOUT', $MODULENAME)} <img src="layouts/v7/modules/CTWhatsApp/image/logout.png" title="{vtranslate('LBL_LOGOUT', $MODULENAME)}"/>
												</p>
											</a>
										</li>
									{/if}
									...
									{if $MAINUSERSTAUSROWS eq 1}
										...
										{else}
											<li class="scanQRCode" style="cursor: pointer;">
												<a href="#">
													<p>{vtranslate('LBL_LOGIN', $MODULENAME)} <img src="layouts/v7/modules/CTWhatsApp/image/login.png" title="{vtranslate('LBL_LOGIN', $MODULENAME)}"/>
													</p>
												</a>
											</li>
										{/if}
							...
							<li>
								<a href="https://kb.crmtiger.com/article-categories/whatsapp-integration-for-vtiger" target="_blank">
									<p>{vtranslate('LBL_HELP', 'Vtiger')} <img src="layouts/v7/modules/CTWhatsApp/image/help.png" title="{vtranslate('LBL_HELP', 'Vtiger')}"/>
									</p>
								</a>
							</li>
						</ul>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div id="broadcastgroup" class="hide">
						<span style="display: block;text-align: right;"><b>{vtranslate('LBL_GROUPMESSAGE', $MODULENAME)}</b></span>
						{if $MULTIPELWHATSAPPNUMBER}
							<select class="select2" name="groupWhatsappNumber" id="groupWhatsappNumber" style="margin: 0;width: 15%">
						...
						{/if}
						<img class="loadNewGroups" src="layouts/v7/modules/CTWhatsApp/image/refresh.png" style="width: 25px;cursor: pointer;" title="{vtranslate('LBL_FETCH_NEW_UPDATE_GROUPS', $MODULENAME)}">
					</div>
									...
									<div class="proDetails">
										...
										<div class="gropMembers1 hide">
											<div class="sent" style="width: 75%;">
												<span>{vtranslate('LBL_GROUP_MEMBERS', $MODULENAME)} - <b class="countGroupMember"></b>
												</span>
											</div>
										</div>
										<div class="msgNo">
						            ...
						            <div class="ws-grp-info">
						                <div class="ws-grp-user">
						                	<div class="groupimagewrapper">
						                        ...
						                        <img class="loadGroupMembers" src="layouts/v7/modules/CTWhatsApp/image/refresh.png" style="width: 25px;cursor: pointer;" title="{vtranslate('LBL_FETCH_NEW_GROUP_MEMBERS', $MODULENAME)}">
						                	</div>
											...
											<div class="ipt-div text-wrapper">
												...
												<div class="icons-wrapper">
													...
													<div class="ipt-ioc-div">
											          	...
											          	<div id="sendTemplates" class="hide" style="cursor: pointer;">
											          	...
											          	<div class="nav-item dropdown">
														    ...
														    <div class="dropdown-menu whatsAppTemplates" style="position: absolute; transform: translate3d(0px, -89px, 0px) !important; top: 0px; left: 0px; will-change: transform;" x-placement="top-start">
