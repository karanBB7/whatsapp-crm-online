...
class Settings_CTWhatsApp_LicenseDetail_View extends Settings_Vtiger_Index_View {
    ...
    public function process(Vtiger_Request $request){
		...
		if($whatsappAction == 'logout'){
			...
			if($resultLogout){
				CTWhatsApp_Record_Model::updateWhatsAppSatatus($currenUserID);
			}
		}
   ...
   function getHeaderScripts(Vtiger_Request $request) {
		...
		$jsFileNames = array(
			"modules.$moduleName.resources.CTWhatsApp",
		);
