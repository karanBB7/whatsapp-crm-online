<?php
/* Smarty version 3.1.39, created on 2023-09-25 05:21:21
  from 'C:\xampp\htdocs\vtigercrm\layouts\v7\modules\CTWhatsAppTemplates\uitypes\Picklist.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_651118d1a63bf5_03915094',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e8b5d7e5eb78c0934db5f43742641ec35bbbf9e9' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtigercrm\\layouts\\v7\\modules\\CTWhatsAppTemplates\\uitypes\\Picklist.tpl',
      1 => 1695618335,
      2 => 'file',
    ),
  ),
...
function content_651118d1a63bf5_03915094 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName() == 'wptemplate_modules') {?><select data-fieldname="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName();?>
...
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ALLMODULES']->value, 'ALLMODULES_VALUE', false, 'ALLMODULES_KEY');
$_smarty_tpl->tpl_vars['ALLMODULES_VALUE']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['ALLMODULES_KEY']->value => $_smarty_tpl->tpl_vars['ALLMODULES_VALUE']->value) {
$_smarty_tpl->tpl_vars['ALLMODULES_VALUE']->do_else = false;
?><option value="<?php echo $_smarty_tpl->tpl_vars['ALLMODULES_KEY']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['SELECTMODULE']->value == $_smarty_tpl->tpl_vars['ALLMODULES_KEY']->value) {?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['ALLMODULES_VALUE']->value,$_smarty_tpl->tpl_vars['ALLMODULES_VALUE']->value);?>
</option><?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select><?php } else { ?><select data-fieldname="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName();?>
" data-fieldtype="picklist" class="inputElement select2 <?php if ($_smarty_tpl->tpl_vars['OCCUPY_COMPLETE_WIDTH']->value) {?> row <?php }?>" type="picklist" name="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName();?>
" <?php if (!empty($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value)) {?>data-validator='<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value);?>
'<?php }?> data-selected-value='<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue');?>
'<?php if ($_smarty_tpl->tpl_vars['FIELD_INFO']->value["mandatory"] == true) {?> data-rule-required="true" <?php }
