...
Vtiger.Class("CTWhatsAppBusiness_CTWhatsaApp_Js",{
        ...
        AppConnector.request(params).then(
            ...
            if(data.result['allMessageshtml'] == ''){
                ...
                var noRecords = '<div class="conversationDiv">' +
                                ...
                                '        <img src="layouts/v7/modules/CTWhatsAppBusiness/image/noRecords.png" style="width: 36px;margin-left: 20px;"/><br>' +
        ...
        jQuery('.showChatMessages').live('click', function (e) {
            ...
            AppConnector.request(params).then(
                function(data) {
                    ...
                    var getTodayMessageRows = data.result['getTodayMessageRows'];
                    ...
                    if(recordId){
                        ...
                        if(messageImportant == '1'){
                            ...
                            jQuery('.importantMessages').find('img').attr('src', 'layouts/v7/modules/CTWhatsAppBusiness/image/favorites-added.png');
                        }else{
                            jQuery('#messagesImportant').val(0);
                            jQuery('.importantMessages').find('img').attr('src', 'layouts/v7/modules/CTWhatsAppBusiness/image/favorites.png');
                        }
                    ...
                    if(whatsappmodule == 'Groups'){
                        ...
                        jQuery('.countGroupMember').html("<a href='/modules/CTWhatsAppBusiness/Exportcon.php?groupMember=1&groupid="+groupid+"'>"+groupMember+"</a>");
                    ...
                    if(manualtransfer == '1'){
                        ...
                        jQuery('.manualtransfer').find('img').attr('src', 'layouts/v7/modules/CTWhatsAppBusiness/image/wa_chatboatfill.png');
                        ...
                        jQuery('.manualtransfer').find('img').attr('src', 'layouts/v7/modules/CTWhatsAppBusiness/image/wa_chatboat.jpg');
                        var message = app.vtranslate('Click on this will stop automatic conversation from Bot');
                        jQuery('.manualtransfer').find('img').attr('title', message);
                    }

                    if(whatsappMessages == '<div class="chatDiv"></div>'){
                        jQuery('.firstMessageText').removeClass('hide');
                        jQuery('.text-wrapper').addClass('hide');
                        jQuery('.hidden-bar-wrapper').addClass('hide');
                        jQuery('.emoji.emoji-button').addClass('hide');
                    }else{
                        jQuery('.firstMessageText').addClass('hide');
                        jQuery('.text-wrapper').removeClass('hide');
                        jQuery('.hidden-bar-wrapper').removeClass('hide');
                        jQuery('.emoji.emoji-button').removeClass('hide');
                    }

                    /*if(getTodayMessageRows == 0){
                        jQuery('.firstMessageText').removeClass('hide');
                        jQuery('.text-wrapper').addClass('hide');
                    }else{
                        jQuery('.firstMessageText').addClass('hide');
                    ...
                    if(relatedModuleHTML){
                        ...
                        jQuery('.relatedModules').html('<b style="font-size: 13px;">'+app.vtranslate('JS_NORELATEDMODULE')+'<a href="index.php?module=CTWhatsAppBusiness&parent=Settings&view=WhatsAppUserList" style="color: blue;">'+app.vtranslate('JS_CLICKHERE')+'</a>'+app.vtranslate('JS_NORELATEDMODULE1')+'</b>');
                    }
            ...
            AppConnector.request(params).then(
                function(data) {
                    ...
                    if(messagesImportant == 1){
                        jQuery('#messagesImportant').val(0);
                        element.find('img').attr('src', 'layouts/v7/modules/CTWhatsAppBusiness/image/favorites.png');
                        app.helper.showSuccessNotification({title: 'Success', message: app.vtranslate('JS_UNIMPORTANT')});
                    }else{
                        jQuery('#messagesImportant').val(1);
                        element.find('img').attr('src', 'layouts/v7/modules/CTWhatsAppBusiness/image/favorites-added.png');
    ...
    registerEventForGetWPTemplates : function(){
        var thisInstance = this;
        jQuery('.sendTemplates').on("click", function() {
    ...
    registerEventsForOpenNewWindowImageFile : function() {
        jQuery('.reply').live("click", function(e) {
            ...
            if(imageURL != 'layouts/v7/modules/CTWhatsAppBusiness/image/pdficon.png' && imageURL != 'layouts/v7/modules/CTWhatsAppBusiness/image/fileicon.png' &&  imageURL != 'layouts/v7/modules/CTWhatsAppBusiness/image/wordicon.jpg'){
...
jQuery(document).ready(function(){
    var thisInstance = new CTWhatsAppBusiness_CTWhatsaApp_Js();
    thisInstance.registerEvents();

    jQuery('.app-footer').remove();
            ...
            if(data.result['iconactive'] == 1 ){
                if(data.result['whatsappicon'] != 0 ){
                    ...
                    if(data.result['isAdmin'] == 'on'){
                        var settingIcon = '<a class=""  href="index.php?module=CTWhatsAppBusiness&parent=Settings&view=WhatsAppUserList" title="WhatsApp Settings" style="display: inline-block;clear: none !important;'+rtlStyle+'padding: 0 4px;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/settings_green.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></a>';
                    }else{
                        var settingIcon = '';
                    }
                                                ...
                                                '<div style="" class="">',
                                                    ...
                                                    '<ul class="dropdown-menu" id="waNotify" style="width: 300px;">',
                                                        ...
                                                        '<li class="boxHead" style="background: #fff;color: #333;padding: 5px 10px;width: 100%;display: inline-block;float: left;border-bottom: 1px solid rgb(44 59 73 / 15%);"> <span style="display: inline-block;float: right;font-size: 14px;font-weight: 700;">Notifications</span><br>',
                                                            ...
                                                            '<a class="allMessageTab hide" href="index.php?module=CTWhatsAppBusiness&view=WhatsappChat&mode=allWhatsAppMSG" style="display: inline-block;clear: none !important;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/listing_green.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></a>',

                                                            '<a class="DashBoardTab" title="WhatsApp Analytics" href="index.php?module=CTWhatsAppBusiness&view=DashBoard&mode=moduleDashBoard&analytics=1" style="display: inline-block;clear: none !important;width: auto !important;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_analytics.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></a>',

                                                            '<a class="whatsAppBotListview" title="Navigate to Chatbot " href="index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=WhatsappBotList" style="display: inline-block;clear: none !important;width: auto !important;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_chatboat.jpg" class="" style="width: 20px;height: 20px;cursor: pointer;"/></a>',

                                                            '<span id="readWhatsAppMessage" title="Mark all notification as read" class="" style="display: inline-block;clear: none !important;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/readmessage.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></span>',

                                                            '<span id="sendNewNumberMessage" title="Send WhatsApp message" class="" style="display: inline-block;clear: none !important;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/new-chat.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></span>',
                                                        ...
                                                        '<li style="width: 100%;display: inline-block;float: left;border-bottom: 1px solid rgb(44 59 73 / 15%);">',
                                                            '<a href="index.php?module=CTWhatsAppBusiness&view=WhatsappChat&mode=allWhatsAppMSG" class="center" style="padding: 10px 10px !important;color: #333 !important;float: right;direction: rtl;width: 100%;text-align: center;"><b style="font-size: 14px;margin: 54px; !important;">Show All Notifications<img src="layouts/v7/modules/CTWhatsAppBusiness/image/listing_green.png" class="" style="width: 20px;height: 20px;cursor: pointer;margin: 0px 13px 3px 5px;"></b>',
                                                            '</a>',
                                                    '</ul>',
                                                ...
                                                '<div style="" class="">',
                                                    ...
                                                    '<ul class="dropdown-menu" id="waNotify" style="width: 300px;">',
                                                        '<li class="boxHead" style="background: #fff;color: #333;padding: 5px 10px;width: 100%;display: inline-block;float: left;border-bottom: 1px solid rgb(44 59 73 / 15%);"> <span style="display: inline-block;float: left;width: 30%;font-size: 14px; font-weight: 700;">Notifications</span>',
                                                            ...
                                                            '<span id="readWhatsAppMessage" title="Mark all notification as read" class="" style="display: inline-block;clear: none !important;width: auto !important;padding: 0 4px;background: transparent !important;float: left !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/readmessage.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></span>',
                                                            ...
                                                            '<span id="sendNewNumberMessage" title="Send WhatsApp message" class="" style="display: inline-block;clear: none !important;float: left !important;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/new-chat.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></span>',

                                                            '<a class="hide" href="index.php?module=CTWhatsAppBusiness&view=WhatsappChat&mode=allWhatsAppMSG" style="display: inline-block;clear: none !important;float: left !important;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/listing_green.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></a>',

                                                            '<a class="hide" href="index.php?module=CTWhatsAppBusiness&view=WhatsappChat&mode=allWhatsAppMSG" style="display: inline-block;clear: none !important;float: left !important;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/listing_green.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></a>',

                                                            '<a class="DashBoardTab" title="WhatsApp Analytics"  href="index.php?module=CTWhatsAppBusiness&view=DashBoard&mode=moduleDashBoard&analytics=1" style="display: inline-block;clear: none !important;float: left !important;width: auto !important;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_analytics.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></a>',
                                                        ...
                                                        ''+data.result['notificationHTML']+'',
                                                        '<li style="width: 100%;display: inline-block;float: left;border-bottom: 1px solid rgb(44 59 73 / 15%);">',
                                                            '<a href="index.php?module=CTWhatsAppBusiness&view=WhatsappChat&mode=allWhatsAppMSG" class="center" style="padding: 10px 10px !important;color: #333 !important;"><b style="font-size: 14px; !important;margin: 54px;">Show All Notifications</b><img src="layouts/v7/modules/CTWhatsAppBusiness/image/listing_green.png" class="" style="width: 20px;height: 20px;cursor: pointer;margin: 0px 0px 0px -50px;">',
                                                            '</a>',
                                                    '</ul>',
