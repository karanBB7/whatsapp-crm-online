...
//		link which shows the summary information(generally detail of record)
    	...
    	// 	$relatedLinks[] = array(
		// 		'linktype' => 'DETAILVIEWTAB',
		// 		'linklabel' => vtranslate('Whatsapp', $moduleName),
		// 		'linkKey' => 'LBL_RECORD_DETAILS',
		// 		'linkurl' => $recordModel->getDetailViewUrl().'&mode=whatsapp&requestMode=full',
		// 		'linkicon' => ''
		// );	
	...
	public function getWidgets() {
		...
		if($moduleModel->isCommentEnabled() && $modCommentswhatsappModel->isPermitted('DetailView')) {
			$widgets[] = array(
					'linktype' => 'DETAILVIEWWIDGET',
					'linklabel' => 'ModCommentswhatsapp',
					'linkurl' => 'module='.$this->getModuleName().'&view=Detail&record='.$this->getRecord()->getId().
							'&mode=showRecentComments&page=1&limit=5'
			);
		}
