			...
			<div class="clearfix">
				...
				<div class="pull-right">
					{if $SELECTEDUSERID neq ''}
						...
						<a class="btn" href="https://crmtiger.com/whatsapp/" target="_blank" title="{vtranslate('LBL_UPGRADETITLE',$QUALIFIED_MODULE)}" style="background-color: #055;color: white;"><img src="layouts/v7/modules/Settings/CTWhatsAppBusiness/images/btn-1.png" style="width: 25px;">&nbsp;&nbsp;{vtranslate('LBL_UPGRADE',$QUALIFIED_MODULE)}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<button class="btn btn-default" onclick="window.location.href='index.php?module=CTWhatsAppBusiness&parent=Settings&view=WhatsAppUserList'">&nbsp;&nbsp;{vtranslate('LBL_CANCEL',$QUALIFIED_MODULE)}</button>
						...
						<tbody>
							...
							<tr class="whatsappStatusBlock {if $WHATSAPPSTATUS eq 0} hide {/if}" style="border: 1px solid;">
								...
								<td colspan="2" style="text-align: center;">
									...
									<label style="font-size: 16px;"><b><a href="index.php?module=CTWhatsAppBusiness&view=WhatsappChat&mode=allWhatsAppMSG" style="color: blue;">{vtranslate('CLICK',$QUALIFIED_MODULE)} {vtranslate('CLICKHERE',$QUALIFIED_MODULE)} </a>{vtranslate('NAVIGATETIMELINE', $QUALIFIED_MODULE)}</b></label>
								</td>
							</tr>
