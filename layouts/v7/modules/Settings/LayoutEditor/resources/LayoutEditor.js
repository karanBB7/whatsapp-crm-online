...
Vtiger.Class('Settings_LayoutEditor_Js', {
	...
	showFieldEditModel: function (data, blockId, fieldContainer) {
		...
		data.find('[name="fieldType"]').on('change', function (e) {
			var fieldTypeValue = jQuery('[name="fieldType"]', form).val();    
			if (fieldTypeValue === 'RelationField') {
				var relatedFieldUi = form.find('.relatedfield');
				relatedFieldUi.removeClass('hide');
			} else {
				var relatedFieldUi = form.find('.relatedfield');
				relatedFieldUi.addClass('hide');
			}
		});
		...
		data.find('[name="fieldType"]').on('change', function (e) {
			var fieldTypeValue = jQuery('[name="fieldType"]', form).val();    
			if (fieldTypeValue === 'RelationModule') {
				var relatedFieldUi = form.find('.relatedmodule');
				var relatedFieldUi2 = form.find('.labelname');
				var relatedFieldUi3 = form.find('.keylabel');
				relatedFieldUi.removeClass('hide');
				relatedFieldUi2.addClass('hide');
				relatedFieldUi3.addClass('hide');
			} else {
				var relatedFieldUi = form.find('.relatedmodule');
				var relatedFieldUi2 = form.find('.labelname');
				var relatedFieldUi3 = form.find('.keylabel');
				relatedFieldUi.addClass('hide');
				relatedFieldUi2.removeClass('hide');
				relatedFieldUi3.removeClass('hide');
			}
		});
		...
		data.find('input[name="KeyLabel"]').on('input', function (e) {
			var inputValue = $(this).val();
			var specialCharsRegex = /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+|\s/;
			
			if (specialCharsRegex.test(inputValue)) {
				data.find('.spanshow').removeClass('hide');
			} else {
				data.find('.spanshow').addClass('hide');
			}
		});
