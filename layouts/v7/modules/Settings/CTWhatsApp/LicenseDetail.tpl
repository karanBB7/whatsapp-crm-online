...
#countdowntimer{
	...
	<div class="container-fluid" id="EditConfigEditor">
		<div class="widget_header row-fluid">
			<a class="btn btn-info pull-right" href="index.php?module=CTWhatsApp&parent=Settings&view=WhatsAppUserList"><i style="font-size:20px !important;" class="fa fa-home"></i></a>
			...
			<button class="btn btn-success editButton" onclick="window.location.href='index.php?parent=Settings&module=CTWhatsApp&view=LicenseEdit'" type="button" title="{vtranslate('LBL_EDIT', $MODULE)}"><strong>{vtranslate('LBL_EDIT', $MODULE)}</strong></button>
			</div>
			</div>	
		</div>
		<br/>
