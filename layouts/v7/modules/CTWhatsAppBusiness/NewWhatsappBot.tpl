					...
					<td colspan="5">
						...
						<div class="parent">
							{foreach key=ALL_WHATSAPP_BOT_KEY item=ALL_WHATSAPP_BOT_VALUE from=$ALL_WHATSAPP_BOT}
								<div class="child" data-botid="{$ALL_WHATSAPP_BOT_KEY}" onclick='window.location.href = "index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=WhatsappBotConfiguration&duplicateRecordId={$ALL_WHATSAPP_BOT_KEY}"'>
									<img src="layouts/v7/modules/CTWhatsAppBusiness/image/templateBot.png" style="width: 100%;"/>
									<br>
									<button class="btn btn-success" onclick='window.location.href = "index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=WhatsappBotConfiguration&duplicateRecordId={$ALL_WHATSAPP_BOT_KEY}"' type="button" style="margin: 2px 0px 4px -1px;" title="{$ALL_WHATSAPP_BOT_VALUE}">
