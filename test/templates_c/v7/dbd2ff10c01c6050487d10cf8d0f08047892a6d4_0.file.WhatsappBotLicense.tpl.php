<?php
/* Smarty version 3.1.39, created on 2023-10-06 09:25:51
  from 'C:\xampp\htdocs\vtigercrm\layouts\v7\modules\CTWhatsAppBusiness\WhatsappBotLicense.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_651fd29f207472_57386149',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dbd2ff10c01c6050487d10cf8d0f08047892a6d4' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtigercrm\\layouts\\v7\\modules\\CTWhatsAppBusiness\\WhatsappBotLicense.tpl',
      1 => 1696583819,
      2 => 'file',
    ),
  ),
...
function content_651fd29f207472_57386149 (Smarty_Internal_Template $_smarty_tpl) {
?><style>#countdowntimer{font-family: sans-serif;color: #fff;display: inline-block;font-weight: 100;text-align: center;font-size: 30px;}#countdowntimer{padding: 10px;border-radius: 3px;background: #00BF96;display: inline-block;}#countdowntimer{padding: 15px;border-radius: 3px;background: #00816A;display: inline-block;}</style><div class="container-fluid" id="EditConfigEditor" style="margin: 0px 0px 0px 26px;"><?php if ($_smarty_tpl->tpl_vars['ISADMIN']->value == 'on') {?><div class="widget_header row-fluid"><div class="span8"><h3><?php echo vtranslate('LBL_LICENSE_CONFIGURATION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></button>&nbsp;&nbsp;<?php }?><button class="btn btn-success editButton" onclick="window.location.href='index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=WhatsappBotLicenseEdit'" type="button" title="<?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['SETTINGMODULE']->value);?>
"><strong><?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['SETTINGMODULE']->value);?>
</strong></button>&nbsp;&nbsp;<a onclick="window.location.href='index.php?module=CTWhatsAppBusiness&view=WhatsappBot&mode=WhatsappBotList'"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/wa_chatboat.jpg" style="width: 24px;"></a></div></div></div><div class="contents"><div style="float: left;width: 65%;"><br><table class="table table-bordered table-condensed themeTableColor" style="font-size:14px;"><tbody><input type="hidden" name="instance" value="<?php echo $_smarty_tpl->tpl_vars['INSTANCE']->value;?>
