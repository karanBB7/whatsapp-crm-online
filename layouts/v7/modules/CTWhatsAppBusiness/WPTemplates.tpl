        ...
        <table class="table table-borderless">
			<tr>
				...
				<td>
					...
					&nbsp;&nbsp;
					<span id="syncWhatsAppTemplates" title="Sync WhatsApp Templates" style="height: 31px;cursor:pointer;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/sync.png" style="width: 24px;"></span>
					&nbsp;&nbsp;
