...
{literal}
    ...
    <link rel="stylesheet" href="layouts/v7/modules/CTWhatsAppBusiness/css/IndicidualPopupRTL.css">
                ...
                <div class="chat-container">
                    ...
                    <div id="call" class="user-bar">
                        ...
                        <div class="name pull-right" title="{$FULLNAME}">
                            ...
                            {/if}
                            {if $PROFILEIMAGE eq ''}
                                <img src="layouts/v7/modules/CTWhatsAppBusiness/image/profileimage.png" alt="Avatar" style="border-radius: 50% !important;">&nbsp;&nbsp;
                            {else}
                                ...
                                {foreach key=WHATSAPPMESSAGESKEY item=WHATSAPPMESSAGESVALUE from=$WHATSAPPMESSAGES}
                                    {if $WHATSAPPMESSAGESVALUE['messageType'] eq 'Recieved'}
                                        <div class="message received">
                                            ...
                                            <span class="metadata">
                                                ...
                                                {if $WHATSAPPMESSAGESVALUE['messageReadUnRead'] eq 'Unread'}
                                                    <img src="layouts/v7/modules/CTWhatsAppBusiness/image/unread.png"/>    
                                                {else}
                                                    <img src="layouts/v7/modules/CTWhatsAppBusiness/image/read.png"/>  
                                                {/if}
                                            </span>&nbsp;
                                        </div>
                                        ...
                                        {else}
                                            {if $RECORDID}
                                                &nbsp;&nbsp;
                                                <span class="editField"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/editcontent.png" title="{vtranslate('LBL_EDITFIELD',$MODULE)} {vtranslate({$SOURCEMODULE},{$SOURCEMODULE})}"></span>
                                            {/if}
                                        {/if}
                                    {else}
                                ...
                                <div class="ipt-div text-wrapper">
                                    ...
                                    <div class="icons-wrapper">
                                        ...
                                        <div class="ipt-ioc-div">
                                            ...
                                            <div id="selectTemplates" class="whatsAppTemplates" style="cursor: pointer;">
