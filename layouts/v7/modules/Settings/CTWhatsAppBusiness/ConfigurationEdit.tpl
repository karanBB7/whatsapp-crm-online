			...
			<div style="float: left;width: 65%;">
				<div class="block">
					<form id="EditView" action="index.php" method="post" class="form-horizontal">
			            <input type="hidden" name="module" value="CTWhatsAppBusiness" />
							...
							<tbody>
								<tr class="hide">
									...
									<td>
										...
										<select name="whatsappmanagement" id="whatsappmanagement" style="width: 100%;" class="inputElement select2">
								...
								{foreach item=MAINSUBUSERS_VALUE key=MAINSUBUSERS_KEY from=$MAINSUBUSERS}
									<tr class="multipleUserSelect hide">
										<td></td>
										<td><a href="index.php?module=Users&view=PreferenceDetail&parent=Settings&record={$MAINSUBUSERS_VALUE['userid']}" target="_blank">{$MAINSUBUSERS_VALUE['userName']}({$MAINSUBUSERS_VALUE['whatsappno']})</a></td>
									...
									<tr class="hide">
										...
										<td class="fieldValue">
											<select class="inputElement select2 select2-offscreen" id="notificationtone" name="notificationtone" style="width: 50%;">
		                                        <option value="">{vtranslate('LBL_SELECT_AN_OPTION', $QUALIFIED_MODULE)}</option>
		                                        <option {if $NOTIFICATIONTON eq 'layouts/v7/modules/CTWhatsAppBusiness/Whatsapp Default.mp3'} selected {/if} value="layouts/v7/modules/CTWhatsAppBusiness/Whatsapp Default.mp3">WhatsApp Default</option>
		                                        <option {if $NOTIFICATIONTON eq 'layouts/v7/modules/CTWhatsAppBusiness/Hangout Message.mp3'} selected {/if} value="layouts/v7/modules/CTWhatsAppBusiness/Hangout Message.mp3">Hangout Message</option>
