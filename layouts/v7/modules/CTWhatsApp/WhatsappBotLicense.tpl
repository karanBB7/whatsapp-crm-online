	...
	{if $ISADMIN eq 1}
		<div class="widget_header row-fluid">
			...
			<div class="span4"><div class="pull-right">
				...
				<button class="btn btn-success editButton" onclick="window.location.href='index.php?module=CTWhatsApp&view=WhatsappBot&mode=WhatsappBotLicenseEdit'" type="button" title="{vtranslate('LBL_EDIT', $SETTINGMODULE)}"><strong>{vtranslate('LBL_EDIT', $SETTINGMODULE)}</strong></button>
				&nbsp;&nbsp;
				<a onclick="window.location.href='index.php?module=CTWhatsApp&view=WhatsappBot&mode=WhatsappBotList'"><img src="layouts/v7/modules/CTWhatsApp/image/wa_chatboat.jpg" style="width: 24px;"></a>
			</div>
			</div>	
		</div>
		<div class="contents">
