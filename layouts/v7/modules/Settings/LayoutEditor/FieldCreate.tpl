				...
				<div class="modal-body model-body-scrollenabled">
					...
					<div class="form-group labelname">
						<label class="control-label fieldLabel col-sm-5">
							...
							&nbsp;<span class="redColor" id="specialCharError">*</span>
						</label>
						<div class="controls col-sm-7">
					...
					<div class="form-group keylabel">
						<label class="control-label fieldLabel col-sm-5">
							{vtranslate('LBL_KEY_LABEL_NAME', $QUALIFIED_MODULE)}
							&nbsp;<span class="redColor">*</span>
						</label>
						<div class="controls col-sm-7">
							<input type="text" class='inputElement col-sm-9 keylabelinput' maxlength="50" {if $IS_FIELD_EDIT_MODE}disabled="disabled"{/if} name="KeyLabel" value="{vtranslate($FIELD_MODEL->get('label'), $SELECTED_MODULE_NAME)}" data-rule-required='true' style='width: 75%'  placeholder="No Special characters allowed"/>
								<br><br>
								
								<span  class="hide spanshow" style="color:red;font-size:10px;"><b>Note:- </b>No special characters or spaces allowed</span>
						</div>
					</div>



					<div class="form-group relatedfield  hide">
						<label class="control-label fieldLabel col-sm-5">
							{vtranslate('LBL_LABEL_RELATE_NAME', $QUALIFIED_MODULE)}
							&nbsp;<span class="redColor">*</span>
						</label>
						<div class="controls col-sm-7">
								<select class="select2 col-sm-6" name="torelatefield">
									{foreach item=MODULE_NAME key=TRANSLATED_MODULE_NAME from=$SUPPORTED_MODULES}
										<option value="{$MODULE_NAME}" {if $MODULE_NAME eq $SELECTED_MODULE_NAME} selected {/if}>
											{$TRANSLATED_MODULE_NAME}
										</option>
					...
					<div class="form-group relatedmodule  hide">
						<label class="control-label fieldLabel col-sm-5">
							{vtranslate('LBL_LABEL_RELATE_NAME', $QUALIFIED_MODULE)}
							&nbsp;<span class="redColor">*</span>
						</label>
						<div class="controls col-sm-7">
								<select class="select2 col-sm-6" name="torelatemodule">
									{foreach item=MODULE_NAME key=TRANSLATED_MODULE_NAME from=$SUPPORTED_MODULES}
										<option value="{$MODULE_NAME}" {if $MODULE_NAME eq $SELECTED_MODULE_NAME} selected {/if}>
											{$TRANSLATED_MODULE_NAME}
										</option>
