...
class Settings_CTWhatsAppBusiness_DeactivateLicense_Action extends Settings_Vtiger_Index_Action {
    ...
    public function process(Vtiger_Request $request) {
		...
		if($rows > 0){
			...
			if($result_response['message'] && in_array($result_response['message'],array('Deactivated','Already Deactivated'))){
				...
				Settings_CTWhatsAppBusiness_Record_Model::deactivateLicense($currenUserID);
