 ...
 ************************************************************************************/
 ...
 class Settings_CTWhatsAppBusiness_ConfigurationEdit_View extends Settings_Vtiger_Index_View {
    ...
    public function process(Vtiger_Request $request) {
		...
		$api_url=Settings_CTWhatsAppBusiness_LicenseDetail_View::encrypt_decrypt($api_url);
		...
		$getMainSubUser = Settings_CTWhatsAppBusiness_Record_Model::getMainSubUsers();
