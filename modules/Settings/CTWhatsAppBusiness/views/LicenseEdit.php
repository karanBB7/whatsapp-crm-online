...
class Settings_CTWhatsAppBusiness_LicenseEdit_View extends Settings_Vtiger_Index_View {
    ...
    public function process(Vtiger_Request $request){
		...
		$api_key = Settings_CTWhatsAppBusiness_ConfigurationEdit_View::encrypt_decrypt($configurationData['api_url']);
