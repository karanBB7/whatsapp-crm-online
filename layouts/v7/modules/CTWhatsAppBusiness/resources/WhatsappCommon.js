...
jQuery.Class("WhatsappCommon_Js",{
        ...
        setTimeout(function(){
            ...
            if(filetype){
                if(filetype.indexOf('image') > -1){
                    ...
                    var newFilename = filename;
                }else if(filetype.indexOf('application/msword') > -1 || filetype.indexOf('application/vnd.openxmlformats-officedocument.wordprocessingml.document') > -1){
                    var newMessageTag = storageURL+'/'+filename;
                    ...
                    var newFilename = filename;
                }else if(filetype.indexOf('application/vnd.openxmlformats-officedocument.presentationml.presentation') > -1){
                    var newMessageTag = storageURL+'/'+filename;
        ...
        jQuery('.editField').live("click", function(e) {
            ...
            popupInstance.showPopup(params,Vtiger_Edit_Js.popupSelectionEvent,function() {
                ...
                jQuery('#saveEditRecord').on("click", function(e) {
                    ...
                    if(fieldname == ''){
                        app.helper.showErrorNotification({'title': 'Error', 'message': 'Please select first any Field.'});
                        return false;
                    }
                    var params = {
                        'module' : 'CTWhatsAppBusiness',
        ...
        jQuery('#wptemplatesid').live("change", function(e) {
            ...
            AppConnector.request(params).then(
                ...
                if(templatesID == ''){
                    ...
                    jQuery('#whatsappTemplateid').val(templatesID);
                }
            });
        });
    },
        ...
        jQuery('#sendNewNumberMessage').live("click", function(e) {
            ...
            popupInstance.showPopup(params,Vtiger_Edit_Js.popupSelectionEvent,function() {
                jQuery('#sendnewnumbermessage').on("click", function(e) {
                    ...
                    var whatsappTemplateid = jQuery("#whatsappTemplateid").val();
                    
                    if(multiWPNumber == ''){
                        app.helper.showErrorNotification({title: 'Error', message: 'Please select any WhatsApp number'});
                        return false;
                    }
                    if(newNumber == ''){
                    ...
                    if(whatsappTemplateid == ''){
                        app.helper.showErrorNotification({title: 'Error', message: 'Please select any WhatsApp Template'});
                        return false;
                    }
    ...
    registerEventForGetWPTemplatesIndividual : function(){
        var thisInstance = this;
        jQuery('#selectTemplates').live("click", function() {
            $('#hamburger').toggleClass('show');
            $('#overlay').toggleClass('show');
            $('.popup-contact').toggleClass('show');
                ...
                if(data.result['iconactive'] == 1 ){
                    if(data.result['whatsappicon'] != 0 ){
                        ...
                        if(data.result['themeView'] == 'RTL'){
                            ...
                            if(data.result['isAdmin'] == 'on'){
                                var settingIcon = '<a class="settingWPTab" title="WhatsApp Settings" href="index.php?module=CTWhatsAppBusiness&parent=Settings&view=WhatsAppUserList" style="display: inline-block;clear: none !important;float: left !important;padding: 0 4px;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/settings_green.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></a>';
                            }else{
                                var settingIcon = '';
                            }
                            var VTPremiumIcon = ['',
                                                    '<ul class="dropdown-menu" id="waNotify" style="width: 300px;display: block;">',
                                                        '<li class="boxHead" style="background: #fff;color: #333;padding: 5px 10px;width: 100%;display: inline-block;float: left;border-bottom: 1px solid rgb(44 59 73 / 15%);"> <span style="display: inline-block;float: left;width: 30%;font-size: 14px; font-weight: 700;">Notifications</span>',
                                                            ...
                                                            '<span id="readWhatsAppMessage" title="Clear all notification messages" class="" style="display: inline-block;clear: none !important;float: left !important;width: auto !important;padding: 0 4px;background: transparent !important;"><img src="layouts/v7/modules/CTWhatsAppBusiness/image/readmessage.png" class="" style="width: 20px;height: 20px;cursor: pointer;"/></span>',
...
jQuery(document).ready(function(){
                ...
                if(data.result['iconactive'] == 1){
                    if(data.result['whatsappicon'] != 0 ){
                        ...
                        if(data.result['moduleIconActive'] == 1){
                            ...
                            if(massButton != 1){
                                var masssendmsg = "<input type='hidden' id='massButton' value='1'><button id='sendmasswhatsappmsg' class='selectFreeRecords btn btn-success'  style='margin: 0px 0px 0px 6px;'>Send WhatsApp Message</button>";
                ...
                function(data) {
                    if(data.result['active'] == 1){
                        ...
                        if(data.result['fieldvalue']){
                            var whatsappimage = "<div id='whatsappIcon' style='margin: 1px 1px 1px 90px;'><input type='hidden' id='whatsappnumber' value='"+data.result['fieldvalue']+"'><img src='layouts/v7/modules/CTWhatsAppBusiness/image/whatsapp.png' style='height: 20px;cursor: pointer;margin: 1px -5px -23px 2px;'>"+notificationcount+"</div>";
    ...
    if((app.getModuleName() == 'CTWhatsAppTemplates' || app.getModuleName() == 'CTWhatsAppBusiness') && app.view() == 'List'){
        ...
        jQuery('#appnav').after("<span title='WhatsApp Business Templates' style='height: 31px;cursor:pointer;'><a href='index.php?module=CTWhatsAppTemplates&view=List'><img src='layouts/v7/modules/CTWhatsAppBusiness/image/wa_templates.png' style='width: 20px;margin: 5px 0px 1px 5px;'/></a></span>");
        ...
        jQuery('#appnav').after("<span id='sendNewNumberMessage' title='Send message to New WhatsApp number' style='height: 31px;cursor:pointer;'><img src='layouts/v7/modules/CTWhatsAppBusiness/image/new-chat.png' style='width: 20px;margin: 5px 0px 1px 5px;'/></span>");
